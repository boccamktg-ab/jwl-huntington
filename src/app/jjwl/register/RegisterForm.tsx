...
export default function RegisterForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {spotsRemaining === 0 ? (
        <div className="bg-amber-50 border-b border-amber-200 px-4 py-3 text-center text-sm text-amber-800">
          <strong>Enrollment is currently at capacity.</strong> You may still register below and we will add you to our waitlist — you'll be notified if a spot opens up.
        </div>
      ) : (
