            ...
            <tr key={m.id} className="hover:bg-gray-50">
              ...
              {showActions && (
                <td className="px-4 py-3 text-right">
                  <MemberActions memberId={m.id} status={m.status} isAdmin={m.is_admin ?? false} isGrantsReviewer={m.is_grants_reviewer ?? false} isJjwlAdmin={m.is_jjwl_admin ?? false} isSuperAdmin={m.is_super_admin ?? false} />
                </td>
              )}
            </tr>
          ))}
